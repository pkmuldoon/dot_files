...
(load "~/.emacs.d/ruby-block.el")
;;(load "~/.emacs.d/dired-details.el")
...
;;(add-to-list 'initial-frame-alist '(width . 220))
;;(add-to-list 'initial-frame-alist '(height . 360))
;;(add-to-list 'initial-frame-alist '(font . "Source Code Pro for Powerline"))
...
;;(add-to-list 'default-frame-alist '(height . 360))
...
(custom-set-faces
 ...
 ;; Your init file should contain only one such instance.
 ;; If there is more than one, they won't work right.
 '(default ((t (:inherit nil :stipple nil :background "#3F3F3F" :foreground "#DCDCCC" :inverse-video nil :box nil :strike-through nil :overline nil :underline nil :slant normal :weight normal :height 200 :width normal :foundry "nil" :family "Source Code Pro for Powerline")))))
